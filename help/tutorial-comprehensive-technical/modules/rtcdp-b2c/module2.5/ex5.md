...
Kinesis和S3都是[配置文件导出目标](https://experienceleague.adobe.com/docs/experience-platform/destinations/destination-types.html?lang=zh-Hans)，可以用作Adobe Experience PlatformReal-Time CDP的一部分。
