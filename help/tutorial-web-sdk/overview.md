...
本教程将指导您在名为Luma的示例零售网站上实施Platform Web SDK。 [Luma网站](https://newluma.enablementadobe.com)具有丰富的数据层和功能，可让您构建现实的实施。 在本教程中，您需要：
...
* 对于&#x200B;**Journey Optimizer**：
   * 对于可选&#x200B;**Web营销活动**&#x200B;课程，您必须具有权限项以&#x200B;**[!UICONTROL 管理营销活动]**、**[!UICONTROL 发布营销活动]**&#x200B;和&#x200B;**[!UICONTROL 查看营销活动报告]**。
  <!--
...
[![Luma网站](assets/old-overview-luma.png)](https://newluma.enablementadobe.com){target="blank"}
