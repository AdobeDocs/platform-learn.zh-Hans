...
>[!NOTE]
>
> 出于演示目的，本课程中的练习构建了一个示例架构，用于捕获客户在[Luma演示网站](https://luma.enablementadobe.com)中查看的内容和购买的产品。 虽然您可以使用这些步骤创建不同的架构以满足您自己的目的，但建议您首先在创建示例架构的同时学习架构编辑器的功能。
...
在本练习中，您将使用推荐的基线字段组创建一个XDM架构，用于捕获[Luma演示网站](https://luma.enablementadobe.com){target="_blank"}上的Web事件数据：
