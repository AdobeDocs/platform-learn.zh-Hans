...
source-git-commit: 0bfaa7725492cf727f7194115feeebc28d3ad9b2
workflow-type: tm+mt
...
>[!NOTE]
>
>本教程使用[Luma网站](https://luma.enablementadobe.com){target=_blank}，该网站已异步实施标记并实施了闪烁抑制。 此部分旨在了解如何通过Platform Web SDK来减少闪烁。
...
1. 导航到[Luma演示站点](https://luma.enablementadobe.com)
1. 导航到产品详细信息页面
