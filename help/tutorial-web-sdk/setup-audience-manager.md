...
1. 打开[Luma主页](https://newluma.enablementadobe.com)（映射到您的标记属性）和&#x200B;**Adobe Experience Platform Debugger**，然后刷新该页面。
...
1. 打开[Luma演示网站主页](https://newluma.enablementadobe.com)并将其映射到您的标记属性，以符合您新创建的区段的条件。
...
1. 选择&#x200B;**`https://newluma.enablementadobe.com`**&#x200B;域并确认您的Cookie已正确写入列表中
