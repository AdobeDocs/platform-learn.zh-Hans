...
了解如何在[Luma演示网站](https://newluma.enablementadobe.com)上的内容、商业和身份数据的标记中创建数据元素。 然后，使用Adobe Experience Platform Web SDK扩展Variable数据元素类型填充XDM架构中的字段。
...
>[!IMPORTANT]
>
>本课程的数据来自Luma网站上的`[!UICONTROL adobeDataLayer]`数据层。 要查看数据层，请打开您的开发人员控制台并键入`[!UICONTROL adobeDataLayer]`，以查看完整可用的数据层。![adobeDataLayer数据层](assets/data-element-data-layer-new.png)
...
在创建XDM对象之前，请为[Luma演示站点](https://newluma.enablementadobe.com){target="_blank"}数据层创建以下数据元素集：
...
1. 使用&#x200B;**[!UICONTROL JavaScript变量]** **[!UICONTROL 数据元素类型]**&#x200B;指向Luma数据层中的一个值： `adobeDataLayer.0.page.name`
...
* **`Ecommerce Checkout Products`**&#x200B;使用以下自定义代码：
