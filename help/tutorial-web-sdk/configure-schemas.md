...
>[!NOTE]
>
> 出于演示目的，本课程中的练习构建了一个示例架构，用于捕获客户在[Luma演示网站](https://luma.enablementadobe.com)中查看的内容和购买的产品。 跟着创建此示例架构以了解架构编辑器的功能，您以后会更准备为自己的业务构建架构。
...
在本练习中，您将使用建议的基线字段组创建一个XDM架构，用于捕获[Luma演示网站](https://luma.enablementadobe.com){target="_blank"}上的Web事件数据：
