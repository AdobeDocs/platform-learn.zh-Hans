...
了解如何使用 Adobe Experience Platform Web SDK 捕获身份标识。捕获[Luma演示站点](https://newluma.enablementadobe.com)上未经身份验证和经过身份验证的标识数据。 了解如何使用您之前创建的数据元素，通过名为身份映射的Platform Web SDK数据元素类型收集经过身份验证的数据。
...
您了解数据层是什么，熟悉[Luma演示站点](https://newluma.enablementadobe.com){target="_blank"}数据层，并了解如何在标记中引用数据元素。 您必须完成本教程中之前的课程：
...
1. **[!UICONTROL Name]**&#x200B;数据元素`Identity Map`
