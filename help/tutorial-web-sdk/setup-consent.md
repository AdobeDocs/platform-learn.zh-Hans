...
1. 在Experience Platform Web SDK标记扩展的&#x200B;**[!UICONTROL 同意]**&#x200B;部分中，确保&#x200B;**[!UICONTROL 默认同意]**&#x200B;设置为&#x200B;**[!UICONTROL In]**：
...
5. 使用此配置，Experience Platform Web SDK扩展会向Platform Edge Network发出网络请求，直到访客决定拒绝Cookie并选择退出为止：
...
1. 作为&#x200B;**[!UICONTROL 操作]**，使用Experience Platform Web SDK扩展[!UICONTROL 设置同意] [!UICONTROL 操作类型]将同意设置为“out”：
...
1. 在Experience Platform Web SDK扩展的&#x200B;**[!UICONTROL 同意]**&#x200B;部分中，根据需要将默认同意设置为&#x200B;**[!UICONTROL Out]**&#x200B;或&#x200B;**[!UICONTROL Pending]**。

1. **将**&#x200B;更新的配置保存到您的标记库并重新生成它。

   ![AEP扩展同意配置](assets/consent-implied-opt-out.png)
