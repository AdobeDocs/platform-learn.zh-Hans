...
1. 按照以下步骤操作： [将](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tag-property)Luma演示网站[上的标记库](https://luma.enablementadobe.com/category-men.html)切换到您在数据流中将事件转发属性映射到的Web SDK标记属性。
