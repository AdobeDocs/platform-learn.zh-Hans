...
在本课程中，您使用[Adobe Experience Platform Debugger扩展](https://chromewebstore.google.com/detail/adobe-experience-platform/bfnnokhpnncpkdmbokanobigaccjkpob)将[Luma演示网站](https://newluma.enablementadobe.com)上硬编码的标记属性替换为您自己的属性。
...
1. 确保已打开[Luma演示网站](https://newluma.enablementadobe.com){target="_blank"}，然后选择Experience Platform Debugger扩展图标
...
1. 返回 [Luma 主页](https://newluma.enablementadobe.com)
...
1. 刷新[Luma主页](https://newluma.enablementadobe.com/)并再次检查&#x200B;**[!UICONTROL Experience Platform Debugger]**，查看数据传入情况。
