...
1. 在&#x200B;**[!UICONTROL 路径下，等于]**&#x200B;设置`/` `OR` `/index.html`。 对于Luma演示网站，它确保规则仅在主页上触发
...
1. 转到[Luma演示网站](https://luma.enablementadobe.com){target="_blank"}
...
您在上面为[Luma主页](https://luma.enablementadobe.com)配置了数据流覆盖。  验证此配置的步骤
...
转到[Livingston All-Purpose Tight product page](https://luma.enablementadobe.com/product.html?id=LLMP09)等产品页面。  验证Analytics是否捕获了内容页面查看。
...
1. 将[Marco轻型活动连帽衫](https://luma.enablementadobe.com/product.html?id=LLMH13)添加到购物车
1. 转到[购物车页面](https://luma.enablementadobe.com/cart.html)，查看Edge跟踪
