---
title: 初始设置 — 将移动应用程序中的Adobe Target实施迁移到Offer Decisioning和Target扩展
...
>[!TAB Offer Decisioning和Target扩展]

使用Offer Decisioning和Target扩展时安装的标记扩展：
...
使用Offer Decisioning和Target扩展时安装的![标记扩展](assets/tag-extensions-decisioning.png)
...
Target扩展具有[可配置的设置](https://developer.adobe.com/client-sdks/solution/adobe-target/#configure-the-target-extension-in-the-data-collection-ui)，使用决策扩展这些设置在数据流[中配置了](https://developer.adobe.com/client-sdks/edge/adobe-journey-optimizer-decisioning/#adobe-experience-platform-data-collection-setup)。
...
| 超时 | 超时 | 可在Offer Decisioning和Target扩展以及优化SDK中进行配置。 默认超时为10秒。 |
