...
| [AEP Edge标识](https://github.com/adobe/aepsdk-edgeidentity-ios) | AEP Edge Identity Mobile扩展(`AEPEdgeIdentity`)可在使用Adobe Experience Platform SDK和Edge Network扩展时处理来自移动应用程序的用户身份数据。 |
...
| [AEP保证](https://github.com/adobe/aepsdk-assurance-ios) | Assurance （也称为项目Griffon）是一种创新的新扩展(`AEPAssurance`)，可帮助您检查、验证、模拟和验证在移动应用程序中收集数据或提供体验的方式。 此扩展可为您的应用程序启用保证。 |
