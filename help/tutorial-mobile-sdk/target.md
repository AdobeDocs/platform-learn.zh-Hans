...
1. 在&#x200B;**[!UICONTROL 无标题的活动]**&#x200B;屏幕中，位于&#x200B;**[!UICONTROL 体验]**&#x200B;步骤：
   ...
   1. 在`luma-mobileapp-abtest`LOCATION 1 **[!UICONTROL 下的]** Select Location **[!UICONTROL 中输入]**。 此位置名称（通常称为mbox）稍后将在应用程序实施中使用。
   1. 选择![默认内容](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ChevronDown_18_N.svg)旁边的&#x200B;**[!UICONTROL Chrevron down]**，然后从上下文菜单中选择&#x200B;**[!UICONTROL 创建JSON选件]**。
