...
时间 *仅限* 在的应用程序中使用应用程序内消息，位于 **[!UICONTROL 安装扩展]** 或 **[!UICONTROL 配置扩展]**，您无需配置任何内容。 但是，如果您已遵循 [推送通知](journey-optimizer-push.md) 在本教程的课程中，您将看到针对 **[!UICONTROL 开发]** 环境， **[!UICONTROL AJO推送跟踪体验事件数据集]** 从以下项中选择数据集 **[!UICONTROL 事件数据集]** 列表。
