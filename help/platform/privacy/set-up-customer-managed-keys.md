...
>[!VIDEO](https://video.tv.adobe.com/v/3413980/?captions=chi_hans&learn=on&enablevpops)
...
>[!WARNING]
>
>设置CMK后，无法还原为系统管理的密钥。 您有责任安全地管理密钥，并提供对Azure中密钥库、密钥和CMK应用程序的访问权限，以防止无法访问您的数据。
