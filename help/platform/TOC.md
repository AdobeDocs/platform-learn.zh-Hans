...
+ [快速入门：数据架构师和数据工程师](https://experienceleague.adobe.com/en/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview){target="_blank"}
...
+ 管理 {#admin}
   ...
   + [将用户添加到数据收集](https://experienceleague.adobe.com/en/docs/platform-learn/data-collection/users-and-permissions)
...
+ 数据摄取 {#data-ingestion}
   ...
   + [从云存储中摄取数据](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage)
   ...
   + [使用HTTP API流式传输数据](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api)
   + [使用Source连接器流式传输数据](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector)
