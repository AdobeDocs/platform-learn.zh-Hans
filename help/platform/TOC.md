...
+ [Platform 教程](/help/platform/overview.md)
+ 平台简介 {#intro-to-platform}
...
+ 数据科学工作区 {#data-science-workspace}
   ...
   + [创建课程架构和数据集](data-science-workspace/create-the-course-schema-and-dataset.md)
   + [在 JupyterLab 笔记本中加载数据](data-science-workspace/load-data-in-jupyterlab-notebooks.md)
   + [在JupyterLab笔记本中查询和发现数据](data-science-workspace/dsw-query-service.md)
   + [探索性数据分析](data-science-workspace/eda.md)
   + [方法、模型和服务概述](data-science-workspace/recipes-models-services-overview.md)
   + [使用方法生成器模板构建模型](data-science-workspace/recipe-builder-template.md)
...
+ 目标 {#destinations}
   ...
   + [创建目标并激活数据](/help/platform/destinations/create-destinations-and-activate-data.md)
   + [将个人资料和区段激活到目标](/help/platform/destinations/activate-profiles-and-segments-to-a-destination.md)
   + [与Google客户匹配集成](/help/platform/destinations/integrate-with-google-customer-match.md)
...
+ 监控 {#monitoring}
   ...
   + [监视数据流](/help/platform/monitoring/data-monitoring.md)
+ 用户档案 {#profiles}
...
+ 架构 {#schemas}
   ...
   + [为B2B数据创建模式](/help/platform/schemas/create-schemas-for-b2b-data.md)
...
+ 区段{#segments}
   ...
   + [根据现有区段创建区段](/help/platform/segments/create-segments-from-existing-segments.md)
...
+ 源 {#sources}
   ...
   + [从Adobe Analytics摄取数据](/help/platform/sources/ingest-data-from-adobe-analytics.md)
   + [从Audience Manager中摄取数据](/help/platform/sources/ingest-data-from-aam.md)
   + [从Marketo摄取数据](/help/platform/sources/ingest-data-from-marketo.md)
...
+ 行业趋势 {#industry}
   ...
   + [打造您的卓越受众中心](/help/platform/industry/evolving-your-audience-center-of-excellence.md)
   + [使用客户用户档案构建更好的体验](/help/platform/industry/building-better-experiences-with-customer-profiles.md)
