...
+ [入门：数据架构师和数据工程师](https://experienceleague.adobe.com/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview.html?lang=zh-Hans){target="_blank"}
...
+ 受众和分段 {#audiences}
   ...
   + [按需评估批受众](/help/platform/audiences/evaluate-audiences-on-demand.md)
   + [评估受众规则](https://experienceleague.adobe.com/docs/experience-platform/segmentation/tutorials/evaluate-a-segment.html?lang=zh-Hans){target="_blank"}
   + [创建数据集以导出数据](https://experienceleague.adobe.com/docs/experience-platform/segmentation/tutorials/create-dataset-export-segment.html?lang=zh-Hans){target="_blank"}
   ...
   + [区段匹配预共享见解](/help/platform/segments/segment-match-pre-share-insights.md)
   + [区段匹配接收数据](/help/platform/segments/segment-match-receiving-data.md)
+ [审核日志](/help/platform/governance/audit-logs.md)
+ [数据收集](https://experienceleague.adobe.com/docs/platform-learn/data-collection/overview.html?lang=zh-Hans){target="_blank"}
+ 协作 {#collaboration}
...
+ 数据引入 {#data-ingestion}
   ...
   + [将CSV文件映射到XDM](https://experienceleague.adobe.com/docs/experience-platform/ingestion/tutorials/map-csv/existing-schema.html?lang=zh-Hans){target="_blank"}
   + [源概述](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/overview.html?lang=zh-Hans)
   + [从Adobe Analytics引入数据](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=zh-Hans)
   + [从Audience Manager引入数据](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-aam.html?lang=zh-Hans)
   ...
   + [从数据库引入数据](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-databases.html?lang=zh-Hans)
   ...
   + [Web SDK教程](https://experienceleague.adobe.com/docs/platform-learn/data-collection/web-sdk/overview.html?lang=zh-Hans){target="_blank"}
   + [Mobile SDK教程](https://experienceleague.adobe.com/docs/platform-learn/data-collection/mobile-sdk/overview.html?lang=zh-Hans){target="_blank"}
...
+ 轮廓 {#profiles}
   ...
   + [自定义配置文件视图详细信息](https://experienceleague.adobe.com/docs/experience-platform/profile/ui/profile-customization.html?lang=zh-Hans){target="_blank"}
...
+ 查询 {#queries}
   ...
   + [从查询结果生成数据集](https://experienceleague.adobe.com/docs/experience-platform/query/ui/create-datasets.html?lang=zh-Hans){target="_blank"}
   ...
   + [将客户端连接到查询服务](https://experienceleague.adobe.com/docs/experience-platform/query/clients/overview.html?lang=zh-Hans){target="_blank"}
...
+ 架构 {#schemas}
   ...
   + [创建临时架构](https://experienceleague.adobe.com/docs/experience-platform/xdm/tutorials/ad-hoc.html?lang=zh-Hans){target="_blank"}
+ 源 {#sources}
...
+ Experience Cloud 集成 {#experience-cloud}
   + [Analytics](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=zh-Hans)
   + [Audience Manager](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-aam.html?lang=zh-Hans)
   + [Commerce](/help/platform/experience-cloud/business-value-of-platform-and-commerce.md)
   + [Marketo Engage](https://experienceleague.adobe.com/docs/platform-learn/tutorials/rtcdp/orchestrate-campaigns-with-marketo-engage.html?lang=zh-Hans)
...
+ Summit {#summit}
   + 2025 {#2025}
      + 短片 {#shorts}
         + 平台 {#platform}
            + [视频短片](/help/summit/2025/shorts/platform/adobe-experience-platform--building-connected-customer-journeys.md)
            + [视频短片](/help/summit/2025/shorts/platform/adobe-s-internal-use-of-aep--driving-experience-led-growth.md)
            + [视频短片](/help/summit/2025/shorts/platform/architecting-adobe-experience-platform-for-scalability.md)
            + [视频短片](/help/summit/2025/shorts/platform/key-takeaways-for-deploying-aep-at-scale.md)
            + [视频短片](/help/summit/2025/shorts/platform/managing-data-governance-and-access-in-aep.md)
            + [视频短片](/help/summit/2025/shorts/platform/optimizing-aep-with-sandbox-tooling.md)
            + [视频短片](/help/summit/2025/shorts/platform/run-and-operate-strategies-for-aep-at-scale.md)
            + [视频短片](/help/summit/2025/shorts/platform/single-vs-multi-sandbox-approach-in-aep.md)
         + RTCDP {#rtcdp}
            + [视频短片](/help/summit/2025/shorts/rtcdp/accelerating-your-audience-strategy-with-real-time-cdp.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/adobe-s-approach-to-audience-strategy-and-activation.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/adobe-s-approach-to-member-onboarding-and-retention.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/adobe-s-internal-use-of-aep--driving-retention-with-data-driven-journeys.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/adobe-s-internal-use-of-unified-profiles-for-creative-cloud.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/ai-assistant--boosting-productivity-in-audience-management.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/ai-assistant-for-audiences--optimizing-audience-strategies.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/audience-agent--proactive-audience-health-monitoring.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/audience-portal--centralizing-and-managing-audiences.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/audience-portal--centralizing-data-for-better-marketing-decisions.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/best-practices-for-data-modeling-in-adobe-experience-platform.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/best-practices-for-schema-design-in-adobe-experience-platform.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/creating-targeted-audiences-with-ai-assistant.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/customer-centric-approach-vs-campaign-centric-approach.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/defining-customer-experience-use-cases.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/discover--activate--and-measure-with-real-time-cdp-collaboration.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/end-to-end-use-case-activation-process.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/evolving-customer-experience-maturity.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/expanding-high-value-audiences-with-look-alike-models.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/federated-audience-composition--expanding-audience-reach.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/federated-audience-composition--expanding-your-reach.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/federated-audience-composition--unifying-data-for-real-time-marketing.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/how-ai-assistant-transforms-data-insights-in-real-time-cdp.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/how-ai-enhances-real-time-cdp-with-predictive-insights.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/how-real-time-cdp-collaboration-works.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/how-to-operate-and-communicate-effectively-in-tiger-teams.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/introducing-adobe-s-agent-orchestrator-for-intelligent-activation.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/introduction-to-real-time-cdp-collaboration.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/key-differentiators-of-real-time-cdp-collaboration.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/run-and-operate-strategies-for-scaling-adobe-experience-platform.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/the-power-of-ai-in-real-time-cdp-for-audience-optimization.md)
            + [视频短片](/help/summit/2025/shorts/rtcdp/three-phased-approach-to-audience-driven-marketing.md)
