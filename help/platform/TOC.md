...
source-git-commit: e6f543c7dcc90116fef0ff1d1a1830334b80303f
workflow-type: tm+mt
...
+ [快速入门：数据架构师和数据工程师](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview){target="_blank"}
...
+ 管理 {#admin}
   ...
   + [将用户添加到数据收集](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/data-collection/users-and-permissions)
...
+ AI 助手 {#ai-assistant}
   ...
   + [Agent Orchestrator界面](/help/platform/ai-assistant/agent-orchestrator-ui.md)
   + [获取访问权限](/help/platform/ai-assistant/access.md)
   + [Audience 代理](/help/platform/ai-assistant/audience-agent-overview.md)
   ...
   + [AI 积分](/help/platform/ai-assistant/ai-credits.md)
...
+ 受众和分段 {#audiences}
   ...
   + 教程{#audience-tutorials}
      ...
      + [吸引数据仓库中的受众](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview){target="_blank"}
...
+ 协作 {#collaboration}
   ...
   + [Collaboration测量 — 设置和报告创建](collaboration/collaboration-measurement-setup-and-report-creation.md)
   + [品牌到品牌](collaboration/brand-to-brand-collaboration.md)
   + [邀请合作伙伴使用Collaboration](collaboration/rtcdp-collaboration-in-product-invitations.md)
+ 仪表板 {#dashboards}
...
+ 数据摄取 {#data-ingestion}
   ...
   + [从云存储中摄取数据](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage)
   ...
   + [使用HTTP API流式传输数据](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api)
   + [使用Source连接器流式传输数据](https://experienceleague.adobe.com/zh-hans/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector)
...
+ 目标 {#destinations}
   ...
   + Data Warehouse {#data-warehouse}
      + [将受众数据发送到Snowflake数据共享批次](/help/platform/destinations/data-warehouse/send-audience-data-snowflake-batch.md)
   + Adobe Target和自定义Personalization{#target}
      ...
      + [激活区段和轮廓属性](/help/platform/destinations/target/activate-segments-and-profile-attributes.md)
...
+ 智能服务 {#intelligent-services}
   ...
   + [使用归因人工智能评分和洞察](/help/platform/intelligent-services/use-attribution-ai-scores-and-insights.md)
   ...
   + [使用客户人工智能评分和洞察](/help/platform/intelligent-services/use-customer-ai-scores-and-insights.md)
+ 监控 {#monitoring}
   ...
   + [流容量管理](monitoring/streaming-management.md)
   + [与Slack集成](monitoring/monitor-events-in-slack.md)
...
+ 查询和数据Distiller {#queries}
   ...
   + [验证数据](/help/platform/queries/explore-data.md)
   + [派生数据](/help/platform/queries/prepare-data.md)
   ...
   + [连接表格](/help/platform/queries/psql-client-tableau.md)
   + [在Tableau中分析和可视化数据](/help/platform/queries/analyze-and-visualize.md)
...
+ 用例战术手册 {#use-case-playbooks}
   ...
   + [配置战术手册沙盒](/help/platform/use-case-playbooks/configure-a-playbook-sandbox.md)
