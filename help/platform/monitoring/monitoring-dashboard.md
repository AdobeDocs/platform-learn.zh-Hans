---
title: 监测数据摄取
description: 了解如何使用监视仪表板监视和跟踪引入 Adobe Experience Platform 的数据。此监视仪表板在源、数据流和数据流运行级别针对通过数据湖对轮廓和身份标识服务的源数据处理提供自上而下的视图，并及时提供可操作的建议。
...
>[!VIDEO](https://video.tv.adobe.com/v/347006?captions=chi_hans&learn=on&enablevpops)
