...
| 响应令牌 | 受支持 | 支持。 有关at.js与Platform Web SDK之间的代码示例和差异，请参阅[专用响应令牌文档](https://experienceleague.adobe.com/docs/target/using/administer/response-tokens.html?lang=zh-Hans) |
