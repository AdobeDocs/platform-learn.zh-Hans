...
1. 从`Luma Loyalty Id`身份命名空间&#x200B;**[!UICONTROL 下拉列表中选择]**&#x200B;命名空间
1. 选择&#x200B;**[!UICONTROL 应用]**
1. 选择&#x200B;**[!UICONTROL 保存]**
...
1. 在`Luma CRM Schema`中，使用`crmId`命名空间将`Luma CRM Id`字段标记为主标识
1. 在`Luma Offline Purchase Events Schema`中，使用`loyaltyId`命名空间将`Luma Loyalty Id`字段标记为主标识
1. 在`Luma Product Catalog Schema`中，使用`productSku`命名空间将`Luma Product SKU`字段标记为主标识
...
1. 选择`crmId`字段
1. 选中&#x200B;**[!UICONTROL 标识]**&#x200B;框
1. 从`Luma CRM Id`身份命名空间&#x200B;**[!UICONTROL 下拉列表中选择]**&#x200B;命名空间
