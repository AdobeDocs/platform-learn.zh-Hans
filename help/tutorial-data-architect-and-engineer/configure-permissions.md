...
[!DNL Admin Console]是用于管理用户对所有Adobe Experience Cloud产品的访问权限的界面。 要访问Platform，必须在Admin Console中添加用户或，然后在Adobe Experience Platform的“权限”屏幕中管理其所有精细的权限项。


以下是Platform现有角色的简要摘要：

* 产品配置文件的&#x200B;**用户**&#x200B;可以根据产品配置文件中分配的权限在Platform用户界面中完成任务。
* **开发人员**&#x200B;可以在Adobe Developer Console中创建API凭据和项目，以便开始使用Experience Platform API
