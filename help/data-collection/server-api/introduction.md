...
经常会看到术语&#x200B;_主机_&#x200B;是指包括任何子域（如`business.adobe.com`）的完整域名。 在引用不带子域（如&#x200B;_）的主机时，经常会看到术语_&#x200B;域&#x200B;_或_&#x200B;域名`adobe.com`。 记住主机的每个部分和变体的特定术语在此处并不重要。 但是，了解这些术语的常用之处很重要，这样您就可以阐明业务和讨论的任何相关细节。
...
除了时间、天气或个性化内容之外，Web API还有许多用途。 推特、TikTok、脸书、LinkedIn、Snapchat、Pinterest等社交媒体平台拥有程序员可以在其应用程序中使用的各种API。 当然，Adobe还有[多种程序员使用的API](https://developer.adobe.com/apis)，以便他们的软件可以与Adobe产品和服务交互。 软件产品和服务通过这些API访问其他软件产品和服务。
