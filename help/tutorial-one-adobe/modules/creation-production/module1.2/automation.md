...
使用Connectors的[1.2.2自动化](./ex2.md){target="_blank"}

在此练习中，继续优化您的历程以自动化图像创建过程。

[1.2.3 Frame.io和Workfront Fusion](./ex3.md){target="_blank"}

在本练习中，您将将Frame.io连接到Workfront Fusion场景。

[1.2.4 Frame.io到Workfront Fusion到AEM Assets](./ex4.md){target="_blank"}
